...
/**
 * This is the model class for table "front_identity".
 *
 * @property string $id
 ...
 */
class FrontIdentity extends \backend\models\BaseModel
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['name', 'update_date', 'create_date', 'create_user'], 'required'],
