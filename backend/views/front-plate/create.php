...
<div class="modal-body">
    ...
    <input type="hidden" class="form-control" id="id" name="id" value="<?php if($plate) echo $plate['id'];?>"/>
    ...
    <div id="title_div" class="form-group">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" id="title" name="FrontPlate[title]" placeholder="必填" value="<?php if($plate) echo $plate['title'];?>"/>
        </div>
    ...
    <div id="introduce_div" class="form-group">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" id="introduce" name="FrontPlate[introduce]" placeholder="" value='<?php if($plate) echo $plate['introduce'];?>'/>
        </div>
        <div class="clearfix"></div>
    </div>
    ...
    <div id="content_div" class="form-group">
        ...
        <div class="col-sm-10">
            <?php if($plate){echo "<input type='hidden' id='content' name='FrontPlate[content]' value='".$plate['content']."'>";}else{echo "<input type='hidden' id='content' name='FrontPlate[content]'>";}?>
            <div>
...
//            $('#content').val(arr);
        var id = $("#id").val();
        var action = id == "" ? "<?=Url::toRoute('front-plate/add-plate')?>" : "<?=Url::toRoute('front-plate/update')?>";
        console.log(action);
        $('#front-plate-form').ajaxSubmit({
            type: "post",
            dataType:"json",
            url: action,
